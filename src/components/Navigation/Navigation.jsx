  ...
  useEffect(() => {
    ...
    if (path === route) {
      ...
      if (
        ...
        if (route !== '/tiers/basic') setEntre(true)
      ...
      <nav className="navbar navbar-light bg-transparent mr-2 ml-2">
        ...
        <a href="#" className="navbar-brand mt-auto">
          <div className="d-flex">
            <img
            src="https://i.dlpng.com/static/png/6808130_preview.png"
            width="50"
            height="50"
            className="d-inline-block align-top other-nav-home"
            alt="" />
            
            <Link to="/" style={{ textDecoration: 'none' }}>
              <h2 className={`mt-1 home ${homeColor} ml-4`}>
                <b>HOME</b>
              </h2>
            </Link>
          </div>
        ...
        { tiers &&
          <div className="d-flex other-nav">
            { entre &&
              <a
                href="https://react-socket-chat-application.web.app/"
                target="_blank"
              ...
              >
                <img 
                  src="https://img.icons8.com/color/35/000000/chat.png"
                  alt="support 24 hours logo"
                />
              </a>
            }
            <Link
